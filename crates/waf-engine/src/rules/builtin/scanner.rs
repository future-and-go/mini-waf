...
pub fn rules() -> Vec<Rule> {
    vec![
        ...
        rule("SCAN-004", "Acunetix Web Vulnerability Scanner", r"(?i)(acunetix|acubw)", "high"),
        ...
        rule("SCAN-007", "Burp Suite proxy/scanner", r"(?i)\bburpsuite\b|\bburp[- ]suite\b", "high"),
        rule("SCAN-008", "OWASP ZAP scanner", r"(?i)\bzap\b.*\bhttp\b|\bowasp.*scanner\b", "high"),
        ...
        rule("SCAN-012", "DirBuster directory bruteforce", r"(?i)\bdirbuster\b", "high"),
