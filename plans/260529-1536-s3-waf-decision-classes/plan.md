...
| 4 | [Engine log_only Semantic Fix](./phase-04-engine-log-only-semantic-fix.md) | Pending | P1 | 3h | Phase 3 |
| 5 | [Rate-Limit Action Mapping](./phase-05-rate-limit-action-mapping.md) | Pending | P1 | 1h | Phase 3 |
